  ...
  return (
    <div className="mt-6 space-y-3 animate-fade-in-up">
      <div className="flex items-center justify-between">
        <div className="h-4 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded w-48 animate-shimmer"></div>
        <div className="h-4 bg-gradient-to-r from-purple-200 via-indigo-200 to-purple-200 rounded w-12 animate-shimmer"></div>
      </div>
      <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden shadow-inner">
        <div className="bg-gradient-to-r from-purple-500 via-indigo-500 to-purple-500 h-4 rounded-full w-1/3 animate-gradient relative overflow-hidden">
